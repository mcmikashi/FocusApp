...
test("check the correcly rendered the title and the focus subject is correcly rendered", () => {
  render(<Timers focusSubject={currentFocus} />);
...
test("check the correcly rendered the title and the focus subject is correcly rendered", () => {
  ...
  render(
    <Timers focusSubject={currentFocus} backToSetFocus={backToSetFocusmock} />
  );
...
test("check that TimerEnd is called when timer is ended", () => {
  ...
  render(<Timers focusSubject={currentFocus} timerEnd={timerEndmock} />);
